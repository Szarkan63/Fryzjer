# Projekt Fryzjer
Aplikacja do zarządzania salonem fryzjerskim stworzona jako projekt na zajęcia akademickie.
...
Dodatkowo system uniemożliwia wybór dat z przeszłości oraz kontroluje dostępność godzin pracy salonu:
...
Sobota: 8:00 – 14:00
 ...
 Wybór terminu w określonych godzinach pracy
 ...
 Baza danych i backend: Supabase (autoryzacja, przechowywanie danych użytkowników i rezerwacji)

Cel projektu

Projekt został stworzony w ramach zajęć akademickich i miał na celu praktyczne wykorzystanie wiedzy z zakresu programowania aplikacji webowych.
